...
const clearDebounce = debounce(clearSelectedArea, 1000, { leading: true, trailing: true })
...
<template>
    <div class="area">
        ...
        <button @click="clearDebounce" class="area__clear">
            <label class="area__clear__type">{{ $t('UI.btnClear')  }}</label>
